            ...
            <section class="text-gray-600 body-font">
              <div class="container px-5 py-4 mx-auto">
                ...
                <div class="flex justify-around">
                  <button onclick="location.href='{{ route("events.past") }}'" class="flex mb-4 text-white bg-neutral-500 border-0 py-2 px-6 focus:outline-none hover:bg-neutral-600 rounded">過去のイベント一覧</button>
